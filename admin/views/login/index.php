...
<form id="login" method="post" action="login.php?accion=login">
  ...
  <!-- Submit button -->
  <input  type="submit" data-mdb-input-init data-mdb-ripple-init class="btn btn-primary btn-block mb-4" value="entrar al sistema" name="enviar"/>

  <!-- Register inputs -->
  <div class="text-center">
    <p>Registrarse ahora<a href="#!">Registrarse</a></p>
    <p>or sign up with:</p>
